...
public class ReportController {
    ...
    public List<ReportLoad> loadUsersLoads(long portalUserId) {
        ...
        try {
            em.clear();
            TypedQuery<ReportLoad> q = em.createQuery("SELECT rl FROM ReportLoad rl WHERE rl.portalUserId = :userId ORDER BY rl.finishTime desc", ReportLoad.class);
    ...
    public List<ReportLoad> loadUsersLoads(List<User> coworkers) {
        ...
        try {
            ...
            em.clear();
            TypedQuery<ReportLoad> q = em.createQuery("SELECT rl FROM ReportLoad rl WHERE rl.portalUserId in :userIds ORDER BY rl.finishTime desc", ReportLoad.class);
