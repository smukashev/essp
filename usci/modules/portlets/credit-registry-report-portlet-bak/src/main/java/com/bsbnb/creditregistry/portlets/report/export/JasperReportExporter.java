...
import com.bsbnb.creditregistry.portlets.report.dm.ReportInputParameter;
...
public class JasperReportExporter extends AbstractReportExporter{
    ...
    protected void exportToXls() {
        try {
            ...
            log.log(Level.INFO, "Report name: {0}", reportName);
            log.log(Level.INFO, "Report path: {0}", reportPath);
            log.log(Level.INFO, "Jasper file path: {0}", jasperFilePath);
            log.log(Level.INFO, "Resource file path: {0}", resourceFilePath);
            ...
            while(resourceEnumeration.hasMoreElements()) {
                ...
                log.log(Level.INFO, "Resource property: {0}={1}", new Object[] {resourceStringName, resourceStringValue});
            }
            ...
            for(Entry<String,Object> entry : reportParameters.entrySet()) {
                log.log(Level.INFO, "Report parameter {0}={1}", new Object[]{entry.getKey(), entry.getValue()});
            }
            ...
            log.log(Level.INFO, "Report exception", jre);
        } catch(IOException ioe) {
            log.log(Level.INFO, "File access exception", ioe);
        } catch(SQLException sqle) {
            log.log(Level.INFO, "SQL exception", sqle);
        }
    }
}
