...
public class ProtocolLayout extends VerticalLayout {
    ...
    private static final String[] FILES_TABLE_VISIBLE_COLUMNS = new String[]{
        "creditorName", "fileLink", "receiverDate", "startDate", "completionDate", "statusName", "actualCount", "processedCount", "reportDate"};
    ...
    private static final String[] FILES_TABLE_COLUMN_NAMES = new String[]{
        "creditorName", "fileLink", "fileName", "receiverDate", "completionDate", "statusName", "startDate", "actualCount", "processedCount", "reportDate"};
