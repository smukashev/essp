...
<database name="model">
  ...
  <table name="eav_sc_child_showcases">
    <column name="id" primaryKey="true" required="true" type="NUMERIC" size="14,0" autoIncrement="true"/>
    <column name="showcase_id" primaryKey="false" required="true" type="NUMERIC" size="14,0" autoIncrement="false"/>
    <column name="name" primaryKey="false" required="false" type="VARCHAR" size="128" autoIncrement="false"/>
    <column name="meta_id" primaryKey="false" required="true" type="NUMERIC" size="14,0" autoIncrement="false"/>
    <column name="child_down_path" primaryKey="false" required="false" type="VARCHAR" size="128" autoIncrement="false"/>
    <!--<foreign-key foreignTable="eav_sc_showcases" name="FK_eav_sc_showcases">
      <reference local="showcase_id" foreign="id"/>
    </foreign-key>-->
  </table>
  <table name="eav_sc_child_showcase_fields">
    <column name="id" primaryKey="true" required="true" type="NUMERIC" size="14,0" autoIncrement="true"/>
    <column name="child_showcase_id" primaryKey="false" required="true" type="NUMERIC" size="14,0" autoIncrement="false"/>
    <column name="attribute_id" primaryKey="false" required="true" type="NUMERIC" size="14,0" autoIncrement="false"/>
