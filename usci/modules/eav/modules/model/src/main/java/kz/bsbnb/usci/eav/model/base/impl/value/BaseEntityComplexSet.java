...
public class BaseEntityComplexSet extends BaseValue<IBaseSet> implements IBaseValue<IBaseSet> {
    public BaseEntityComplexSet(long id, long creditorId, Batch batch, long index, Date reportDate, IBaseSet value,
                                boolean closed, boolean last) {
        super(id, creditorId, batch, index, reportDate, value, closed, last);
    }

    public BaseEntityComplexSet(long creditorId, Batch batch, long index, IBaseSet value) {
