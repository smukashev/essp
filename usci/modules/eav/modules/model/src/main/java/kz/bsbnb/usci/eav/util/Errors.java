...
public enum Errors {
    ...
    static {
        ...
        errors.put("E115", "Дата закрытия не может быть одинаковой или раньше даты открытия");
        ...
        errors.put("E299", "Существует активная запись на отчетную дату #reportDate со значением #value. Закрытие невозможно");
        errors.put("E300", "");
        errors.put("E301", "");
        errors.put("E302", "");
        errors.put("E303", "");
