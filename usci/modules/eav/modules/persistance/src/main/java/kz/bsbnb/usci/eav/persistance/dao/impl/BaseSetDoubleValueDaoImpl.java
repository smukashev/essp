...
public class BaseSetDoubleValueDaoImpl extends JDBCSupport implements IBaseSetDoubleValueDao {
    ...
    protected void update(long id, long baseSetId, long creditorId, Date reportDate, Object value, boolean closed,
        ...
        if (count != 1)
            throw new IllegalStateException(Errors.getMessage(Errors.E144, count, id));
    ...
    protected void delete(long id) {
        ...
        if (count != 1)
            throw new IllegalStateException(Errors.getMessage(Errors.E143, count, id));
    }
    ...
    public void loadBaseValues(IBaseSet baseSet, Date actualReportDate) {
        ...
        Table tableNumbering = context
                ...
                .and(tableOfValues.field(EAV_BE_DOUBLE_SET_VALUES.REPORT_DATE).lessOrEqual(DataUtils.convert(actualReportDate)))
                .asTable("ssvn");
