            ...
            if (insertedObjects != null && insertedObjects.size() != 0) {
                ...
                for (IPersistable insertedObject : insertedObjects) {
                    try {
                        ...
                        logger.error(Errors.getError(Errors.E76) + ": \n" + e.getMessage()
                                + "\n" + insertedObject);
                        throw new IllegalStateException(Errors.compose(Errors.E76,e));
                    }
                }
            }
        }
            ...
            if (updatedObjects != null && updatedObjects.size() != 0) {
                ...
                for (IPersistable updatedObject : updatedObjects) {
                    try {
                        ...
                        logger.error(Errors.getError(Errors.E77) + " : \n" + e.getMessage() + "\n" + updatedObject);
                        throw new IllegalStateException(Errors.compose(Errors.E77,e));
                    }
                }
            }
        }
            ...
            if (deletedObjects != null && deletedObjects.size() != 0) {
                ...
                for (IPersistable deletedObject : deletedObjects) {
                    try {
                        ...
                        logger.error(Errors.getError(Errors.E78) + " : \n" + e.getMessage()
                                + "\n" + deletedObject);
                        throw new IllegalStateException(Errors.compose(Errors.E78,e));
                    }
                }
            }
        }
