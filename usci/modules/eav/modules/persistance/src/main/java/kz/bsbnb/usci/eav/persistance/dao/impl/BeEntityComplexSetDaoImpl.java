...
public class BeEntityComplexSetDaoImpl extends JDBCSupport implements IBeEntityComplexSetDao {
    ...
    public IBaseValue getNextBaseValue(IBaseValue baseValue)
    {
        ...
        Table subqueryTable = context
                .select(DSL.rank().over()
                        ...
                        EAV_BE_ENTITY_COMPLEX_SETS.as(tableAlias).BATCH_ID,
                        EAV_BE_ENTITY_COMPLEX_SETS.as(tableAlias).INDEX_,
        ...
        Select select = context
                .select(subqueryTable.field(EAV_BE_ENTITY_COMPLEX_SETS.ID),
                        subqueryTable.field(EAV_BE_ENTITY_COMPLEX_SETS.BATCH_ID),
                        subqueryTable.field(EAV_BE_ENTITY_COMPLEX_SETS.INDEX_),
        ...
        if (rows.size() == 1)
        {
            ...
            beComplexSetValueDao.loadBaseValues(baseSet, reportDate, false);
    ...
    public IBaseValue getClosedBaseValue(IBaseValue baseValue) {
        ...
        if (rows.size() == 1)
        {
            ...
            IBaseSet baseSet = new BaseSet(setId, metaSet.getMemberType());
            beComplexSetValueDao.loadBaseValues(baseSet, baseValue.getRepDate(), false);
    ...
    public void loadBaseValues(IBaseEntity baseEntity, Date actualReportDate, boolean lastReportDate)
    {
        ...
        while (it.hasNext())
        {
            ...
            beComplexSetValueDao.loadBaseValues(baseSet, actualReportDate, lastReportDate);
