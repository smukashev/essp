...
public class BaseSetBooleanValueDaoImpl extends JDBCSupport implements IBaseSetBooleanValueDao {
    ...
    protected void update(long id, long baseSetId, long creditorId, Date reportDate, Object value, boolean closed,
        ...
        if (count != 1)
            throw new IllegalStateException(Errors.compose(Errors.E132, count, id));
    ...
    protected void delete(long id) {
        ...
        if (count != 1)
            throw new IllegalStateException(Errors.compose(Errors.E131, count, id));
    }
    ...
    public void loadBaseValues(IBaseSet baseSet, Date existingReportDate, Date savingReportDate) {
        ...
        select = context
                .select(tableNumbering.field(EAV_BE_BOOLEAN_SET_VALUES.ID),
                        ...
                        tableNumbering.field(EAV_BE_BOOLEAN_SET_VALUES.IS_CLOSED),
