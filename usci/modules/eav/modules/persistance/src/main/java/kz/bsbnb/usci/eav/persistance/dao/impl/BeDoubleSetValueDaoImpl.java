...
import kz.bsbnb.usci.eav.persistance.dao.IBeDoubleSetValueDao;
 ...
 */
@Repository
public class BeDoubleSetValueDaoImpl extends JDBCSupport implements IBeDoubleSetValueDao
{

    private final Logger logger = LoggerFactory.getLogger(BeDoubleSetValueDaoImpl.class);
