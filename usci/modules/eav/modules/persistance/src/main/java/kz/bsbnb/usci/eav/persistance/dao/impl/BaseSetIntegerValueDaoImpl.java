...
public class BaseSetIntegerValueDaoImpl extends JDBCSupport implements IBaseSetIntegerValueDao {
    ...
    protected void update(long id, long baseSetId, long creditorId, Date reportDate, Object value, boolean closed, boolean last) {
        ...
        if (count != 1)
            throw new IllegalStateException(Errors.compose(Errors.E146,count, id));
    ...
    protected void delete(long id) {
        ...
        if (count != 1)
            throw new IllegalStateException(Errors.compose(Errors.E145, count, id));
    }
    ...
    private IBaseValue constructValue (Map<String, Object> row, IMetaType metaType) {
        ...
        boolean closed = ((BigDecimal) row.get(EAV_BE_INTEGER_SET_VALUES.IS_CLOSED.getName())).longValue() == 1;
    ...
    public IBaseValue getExistingBaseValue (IBaseValue baseValue) {
        ...
        Select select = context
                .select(EAV_BE_INTEGER_SET_VALUES.as(tableAlias).ID,
                        ...
                        EAV_BE_INTEGER_SET_VALUES.as(tableAlias).VALUE,
    ...
    public IBaseValue getPreviousBaseValue(IBaseValue baseValue) {
        ...
        Table subQueryTable = context
                ...
                .and(EAV_BE_INTEGER_SET_VALUES.as(tableAlias).CREDITOR_ID.equal(baseValue.getCreditorId()))
                .and(EAV_BE_INTEGER_SET_VALUES.as(tableAlias).VALUE.equal((Integer) baseValue.getValue()))
                .and(EAV_BE_INTEGER_SET_VALUES.as(tableAlias).REPORT_DATE.lessThan(DataUtils.convert(baseValue.getRepDate())))
        ...
        Select select = context
                .select(subQueryTable.field(EAV_BE_INTEGER_SET_VALUES.ID),
                        ...
                        subQueryTable.field(EAV_BE_INTEGER_SET_VALUES.VALUE),
    ...
    public IBaseValue getNextBaseValue(IBaseValue baseValue) {
        ...
        Table subQueryTable = context
                ...
                .and(EAV_BE_INTEGER_SET_VALUES.as(tableAlias).VALUE.equal((Integer) baseValue.getValue()))
                .and(EAV_BE_INTEGER_SET_VALUES.as(tableAlias).CREDITOR_ID.equal(baseValue.getCreditorId()))
                .and(EAV_BE_INTEGER_SET_VALUES.as(tableAlias).REPORT_DATE.greaterThan(DataUtils.convert(baseValue.getRepDate())))
                .asTable(subQueryAlias);
    ...
    public IBaseValue getClosedBaseValue(IBaseValue baseValue) {
        ...
        Select select = context
                ...
                .where(EAV_BE_INTEGER_SET_VALUES.as(tableAlias).SET_ID.equal(baseContainer.getId()))
                .and(EAV_BE_INTEGER_SET_VALUES.as(tableAlias).CREDITOR_ID.equal(baseValue.getCreditorId()))
                .and(EAV_BE_INTEGER_SET_VALUES.as(tableAlias).REPORT_DATE.lessOrEqual(DataUtils.convert(baseValue.getRepDate())))
                .and(EAV_BE_INTEGER_SET_VALUES.as(tableAlias).VALUE.equal((Integer) baseValue.getValue()))
    ...
    public void loadBaseValues(IBaseSet baseSet, Date existingReportDate, Date savingReportDate) {
        ...
        select = context
                .select(tableNumbering.field(EAV_BE_INTEGER_SET_VALUES.ID),
                        ...
                        tableNumbering.field(EAV_BE_INTEGER_SET_VALUES.IS_CLOSED),
