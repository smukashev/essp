...
public class BaseSetIntegerValueDaoImpl extends JDBCSupport implements IBaseSetIntegerValueDao
{
    ...
    public void loadBaseValues(IBaseSet baseSet, Date actualReportDate, boolean lastReportDate)
    {
        ...
        {
            select = context
                    .select(tableOfValues.field(EAV_BE_INTEGER_SET_VALUES.ID),
                            tableOfValues.field(EAV_BE_INTEGER_SET_VALUES.BATCH_ID),
                            tableOfValues.field(EAV_BE_INTEGER_SET_VALUES.INDEX_),
                    ...
                    .from(tableOfValues)
                    .where(tableOfValues.field(EAV_BE_INTEGER_SET_VALUES.SET_ID).equal(baseSet.getId()))
                    .and(tableOfValues.field(EAV_BE_INTEGER_SET_VALUES.IS_LAST).equal(true)
                            .and(tableOfValues.field(EAV_BE_INTEGER_SET_VALUES.IS_CLOSED).equal(false)));
        }
        else
        {
            ...
            select = context
                    .select(tableNumbering.field(EAV_BE_INTEGER_SET_VALUES.ID),
                            tableNumbering.field(EAV_BE_INTEGER_SET_VALUES.BATCH_ID),
                            tableNumbering.field(EAV_BE_INTEGER_SET_VALUES.INDEX_),
                    ...
                    .and(tableNumbering.field(EAV_BE_INTEGER_SET_VALUES.IS_CLOSED).equal(false));
        }
        ...
        while (it.hasNext())
        {
            ...
            long batchId = ((BigDecimal)row.get(EAV_BE_INTEGER_SET_VALUES.BATCH_ID.getName())).longValue();
            long index = ((BigDecimal) row.get(EAV_BE_INTEGER_SET_VALUES.INDEX_.getName())).longValue();
    ...
    public Date getNextReportDate(long baseSetId, Date reportDate)
    {
        ...
        Select select = context
                ...
                .where(EAV_BE_INTEGER_SET_VALUES.as(tableAlias).SET_ID.eq(baseSetId))
                .and(EAV_BE_INTEGER_SET_VALUES.as(tableAlias).REPORT_DATE.greaterThan(DataUtils.convert(reportDate)));
    ...
    public Date getPreviousReportDate(long baseSetId, Date reportDate)
    {
        ...
        Select select = context
                ...
                .from(EAV_BE_INTEGER_SET_VALUES.as(tableAlias))
                .where(EAV_BE_INTEGER_SET_VALUES.as(tableAlias).SET_ID.eq(baseSetId))
                .and(EAV_BE_INTEGER_SET_VALUES.as(tableAlias).REPORT_DATE.lessThan(DataUtils.convert(reportDate)));
