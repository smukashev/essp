...
public class BaseEntityDoubleValueDaoImpl extends JDBCSupport implements IBaseEntityDoubleValueDao {
    ...
    public void complexUpdate(IPersistable persistable) {
        ...
        Update update = context
                ...
                .set(EAV_BE_DOUBLE_VALUES.as(tableAlias).VALUE, DataUtils.convert((Date) baseValue.getValue()))
    ...
    public void loadBaseValues(IBaseEntity baseEntity, Date existingReportDate, Date savingReportDate) {
        ...
        select = context
                ...
                .and((tableNumbering.field(EAV_BE_DOUBLE_VALUES.IS_CLOSED).equal(false)
                        ...
                        .or(tableNumbering.field(EAV_BE_DOUBLE_VALUES.REPORT_DATE).equal(savingReportDate)
