...
public class BaseEntityDateValueDaoImpl extends JDBCSupport implements IBaseEntityDateValueDao {
    ...
    protected void update(long id, long baseEntityId, long creditorId, long metaAttributeId, Date reportDate,
        ...
        if (count != 1)
            throw new IllegalStateException(Errors.E96 + "|" + count + "|" + id);
    }
    ...
    protected void delete(long id) {
        ...
        if (count != 1)
            throw new IllegalStateException(Errors.E95 + "|" + count + "|" + id);
    }
    ...
    public IBaseValue getPreviousBaseValue(IBaseValue baseValue) {
        ...
        if (baseContainer == null)
            throw new IllegalStateException(Errors.E81 + "|" + baseValue.getMetaAttribute().getName());
