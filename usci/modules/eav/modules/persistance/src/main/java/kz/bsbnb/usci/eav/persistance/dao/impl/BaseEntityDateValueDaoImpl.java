...
public class BaseEntityDateValueDaoImpl extends JDBCSupport implements IBaseEntityDateValueDao {
    ...
    protected long insert(long baseEntityId, long creditorId, long metaAttributeId, Date reportDate, Object value,
        ...
        Insert insert = context
                ...
                .set(EAV_BE_DATE_VALUES.CREDITOR_ID, creditorId)
    ...
    protected void update(long id, long baseEntityId, long creditorId, long metaAttributeId, Date reportDate,
        ...
        Update update = context
                ...
                .set(EAV_BE_DATE_VALUES.as(tableAlias).CREDITOR_ID, creditorId)
        ...
        if (count != 1)
            throw new IllegalStateException(Errors.getMessage(Errors.E96, count, id));
    }
    ...
    protected void delete(long id) {
        ...
        if (count != 1)
            throw new IllegalStateException(Errors.getMessage(Errors.E95, count, id));
    }
    ...
    public IBaseValue getPreviousBaseValue(IBaseValue baseValue) {
        ...
        if (baseContainer == null)
            throw new IllegalStateException(Errors.getMessage(Errors.E81, baseValue.getMetaAttribute().getName()));
    ...
    public void loadBaseValues(IBaseEntity baseEntity, Date actualReportDate) {
        ...
        select = context
                .select(tableOfAttributes.field(EAV_M_SIMPLE_ATTRIBUTES.NAME),
                        ...
                        tableNumbering.field(EAV_BE_DATE_VALUES.CREDITOR_ID),
