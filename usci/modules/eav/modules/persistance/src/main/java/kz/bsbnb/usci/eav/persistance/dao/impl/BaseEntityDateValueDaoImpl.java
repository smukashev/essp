...
public class BaseEntityDateValueDaoImpl extends JDBCSupport implements IBaseEntityDateValueDao {
    ...
    protected void update(long id, long baseEntityId, long creditorId, long metaAttributeId, Date reportDate,
        ...
        if (count != 1)
            throw new IllegalStateException(Errors.compose(Errors.E96, count, id));
    }
    ...
    public void loadBaseValues(IBaseEntity baseEntity, Date existingReportDate, Date savingReportDate) {
        ...
        Table tableNumbering = context
                ...
                .and(tableOfValues.field(EAV_BE_DATE_VALUES.REPORT_DATE).lessOrEqual(DataUtils.convert(loadingDate)))
                .asTable("vn");
