...
public class BaseSetDateValueDaoImpl extends JDBCSupport implements IBaseSetDateValueDao {
    ...
    private IBaseValue constructValue (Map<String, Object> row, IMetaType metaType) {
        ...
        boolean closed = ((BigDecimal) row.get(EAV_BE_DATE_SET_VALUES.IS_CLOSED.getName())).longValue() == 1;
    ...
    public IBaseValue getExistingBaseValue(IBaseValue baseValue) {
        ...
        Select select = context
                ...
                .and(EAV_BE_DATE_SET_VALUES.as(tableAlias).REPORT_DATE.equal(DataUtils.convert(baseValue.getRepDate())));
    ...
    public IBaseValue getPreviousBaseValue(IBaseValue baseValue) {
        ...
        Table subQueryTable = context
                ...
                .and(EAV_BE_DATE_SET_VALUES.as(tableAlias).CREDITOR_ID.equal(baseValue.getCreditorId()))
                .and(EAV_BE_DATE_SET_VALUES.as(tableAlias).VALUE.equal(DataUtils.convert((Date) baseValue.getValue())))
                .and(EAV_BE_DATE_SET_VALUES.as(tableAlias).REPORT_DATE.lessThan(DataUtils.convert(baseValue.getRepDate())))
    ...
    public IBaseValue getClosedBaseValue(IBaseValue baseValue) {
        ...
        Select select = context
                ...
                .where(EAV_BE_DATE_SET_VALUES.as(tableAlias).SET_ID.equal(baseContainer.getId()))
                .and(EAV_BE_DATE_SET_VALUES.as(tableAlias).CREDITOR_ID.equal(baseValue.getCreditorId()))
                .and(EAV_BE_DATE_SET_VALUES.as(tableAlias).REPORT_DATE.lessOrEqual(DataUtils.convert(baseValue.getRepDate())))
                .and(EAV_BE_DATE_SET_VALUES.as(tableAlias).VALUE.equal(DataUtils.convert((Date) baseValue.getValue())))
    ...
    public void loadBaseValues(IBaseSet baseSet, Date existingReportDate, Date savingReportDate) {
        ...
        Table tableNumbering = context
                ...
                .and(tableOfValues.field(EAV_BE_DATE_SET_VALUES.REPORT_DATE).lessOrEqual(DataUtils.convert(existingReportDate)))
                .asTable("ssvn");
