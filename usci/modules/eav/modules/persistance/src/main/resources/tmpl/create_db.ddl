...
<database name="model">
	<table name="eav_m_classes">
		...
		<column name="history_type" primaryKey="false" required="false" type="NUMERIC" size="2" autoIncrement="false"/>
	...
	<table name="eav_batches">
		...
		<column name="sign_info" primaryKey="false" required="false" type="VARCHAR" size="4000" autoIncrement="false"/>
		<column name="sign_time" primaryKey="false" required="false" type="TIMESTAMP" autoIncrement="false"/>
  ...
  <table name="eav_log_deletes">
	  <column name="id" primaryKey="true" required="true" type="NUMERIC" size="14,0" autoIncrement="true" />
	  <column name="batch_id" primaryKey="false" required="true" type="NUMERIC" size="14,0" autoIncrement="false" />
	  <column name="user_id" primaryKey="false" required="true" type="NUMERIC" size="14,0" autoIncrement="false" />
	  <column name="base_value_id" primaryKey="false" required="true" type="NUMERIC" size="14,0" autoIncrement="false" />
