...
BEGIN
  ...
  update LX_CONT_MATURITY_DATE_MISM lx set lx.cr_p_cont_date= null, lx.cr_issue_date = null, lx.cr_not_found=0 where lx.credit_id is not null;
  ...
  for credit in (select * from LX_CONT_MATURITY_DATE_MISM)
   loop
      ...
      begin
            ...
            UPDATE LX_CONT_MATURITY_DATE_MISM lx
                SET lx.cr_issue_date=v_cr_maturity_date
            WHERE
                lx.P_CONT_NO   =credit.p_cont_no
                AND lx.P_CONT_DATE   =credit.p_cont_date;
