create or replace PROCEDURE "LX_PASTDUE_VAL1_FIX" IS
BEGIN

  for pd in (select * from LX_PASTDUE_VAL1)
   loop
      declare
      crValue number;
      crOpenDate date;
...
--              and attribute_id = 53;
       ...
       EXCEPTION
        WHEN no_data_found THEN
          update LX_PASTDUE_VAL1 set cr_not_found=1 where pastdue_id=pd.pastdue_id;
